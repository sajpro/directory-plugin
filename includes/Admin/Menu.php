...
class Menu {
	...
	public function admin_menu() {
		...
		$hook = add_menu_page( esc_html__( 'Directory Plugin', 'directory-plugin' ), esc_html__( 'Directory Plugin', 'directory-plugin' ), $capability, $parent_slug, [ $this, 'all_listings_page' ], 'dashicons-welcome-learn-more' );
